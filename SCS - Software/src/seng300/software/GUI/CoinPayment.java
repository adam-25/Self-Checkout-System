...
public class CoinPayment extends JPanel {
	...
	public CoinPayment() {
		...
		gridBagLayout.rowHeights = new int[]{5, 0, 10, 0, 10, 100, 10, 50, 5, 0};
		...
		totalCoinsLabel.setFont(new Font("Tahoma", Font.PLAIN, 24));
		...
		gbc_totalCoinsValue.fill = GridBagConstraints.HORIZONTAL;
		gbc_totalCoinsValue.insets = new Insets(0, 0, 5, 5);
		gbc_totalCoinsValue.gridx = 3;
		gbc_totalCoinsValue.gridy = 1;
